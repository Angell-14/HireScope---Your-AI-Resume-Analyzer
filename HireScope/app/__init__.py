...
st.set_page_config(
   ...
   page_icon='app/imgs/portfolio.png',
)


def run():
    img = Image.open('app/imgs/img1.png')
    st.image(img)
    ...
    link = '[© Developed by Angel ](https://www.linkedin.com/in/Angel1411/)'
        ...
        if choice == "Signup":
            ...
            if st.button('Sign Up'):
                if new_password == confirm_password:
                    ...
                    st.success("Signup successfull! Now you can login.")
                else:
                    st.error("Password doesn't match. Try again...")
